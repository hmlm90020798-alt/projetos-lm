  ...
  return `
    <div class="proj-card ${faseClasse}${temOcorr ? ' card-ocorrencia' : ''}" onclick="window.ativarModoApresentacao('${p.id}')">
      ...
      <div class="card-actions">
        ...
        <button class="btn-card acomp" onclick="event.stopPropagation();window.abrirDrawerAcompanhamento('${p.id}')" title="Acompanhamento — Interacções, Ocorrências, Mensagens">👁 Seguir</button>
